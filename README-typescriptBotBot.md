# typescript bot Bot - `typescriptBotBot`
...
3. Give the bot a handle (ex: `typescriptBotBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://typescriptbr.azurewebsites.net/api/messages`
